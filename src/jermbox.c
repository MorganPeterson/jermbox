...
static JanetReg cfuns[] = {
  {"jermbox-init", cfun_init, "Initializes the jermbox library"},
  {"jermbox-init-file", cfun_init_file, "Initializes jermbox to a file"},
  {"jermbox-shutdown", cfun_shutdown, "Shutdown and finalize jermbox"},
  {"jermbox-width", cfun_tb_width, "Returns size of internal back buffer"},
  {"jermbox-height", cfun_tb_height, "Returns size of internal back buffer"},
  {"jermbox-clear", cfun_tb_clear, "Clears internal back buffer using default colors"},
  {"jermbox-set-clear-attributes", cfun_tb_set_clear_attributes, "Clears internal back buffer using supplied fg/bg colors"},
  {"jermbox-present", cfun_tb_present, "Synchronizes internal backbuffer with termainal"},
  {"jermbox-set-cursor", cfun_tb_set_cursor, "Set cursor position"},
  {"jermbox-set-cursor", cfun_tb_put_cell, "Changes cell's parameters"},
  {"jermbox-change-cell", cfun_tb_change_cell, "Changes cell's parameters"},
  {"jermbox-blit", cfun_tb_blit, "Copies the buffer from given positions"},
  {"jermbox-select-input-mode", cfun_tb_select_input_mode, "Set input mode"},
  {"jermbox-select-output-mode", cfun_tb_select_output_mode, "Set output mode"},
  {"jermbox-peek-event", cfun_tb_peek_event, "Wait for event for timout length"},
  {"jermbox-poll-event", cfun_tb_poll_event, "Wait for event forever"},
  {"jermbox-utf8-char-length", cfun_utf8_char_length, "get length of character"},
  {"jermbox-utf8-char-to-unicode", cfun_utf8_char_to_unicode, "Convert character"},
  {"jermbox-utf8-unicode-to-char", cfun_utf8_unicode_to_char, "Convert unicode"},
  {NULL, NULL, NULL}
};
